...
export interface IpIntelligenceProfile {
    whiteLists: string[];
    whiteListsEx?: { id: string, name: string }[];
    blackLists: string[];
...
export function cloneDevicePosture(val: DevicePosture): DevicePosture {
    return {
        ...
        discEncryption: UtilService.isUndefinedOrNull(val.discEncryption) ? undefined : val.discEncryption,
...
export interface DeviceProfile {
    ...
    postures: string[];
    posturesEx?: { id: string, name: string }[]
}
