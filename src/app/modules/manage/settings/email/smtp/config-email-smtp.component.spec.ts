...
import { ConfigEmailSmtpComponent } from './config-email-smtp.component';

describe('ConfigEmailSmtpComponent', () => {
  let component: ConfigEmailSmtpComponent;
  let fixture: ComponentFixture<ConfigEmailSmtpComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ConfigEmailSmtpComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ConfigEmailSmtpComponent);
