...
describe('ConfigFqdnIntelligenceComponent', () => {
  let component: ConfigFqdnIntelligenceComponent;
  let fixture: ComponentFixture<ConfigFqdnIntelligenceComponent>;
  const httpClientSpy = jasmine.createSpyObj('HttpClient', ['post', 'get', 'put']);
  let confirmService: ConfirmService;
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ConfigFqdnIntelligenceComponent],
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ConfigFqdnIntelligenceComponent);
