...
// https://testing-angular.com/testing-components/#querying-the-dom-with-test-ids
...
/**
 * Returns a selector for the `test-id` attribute with the given attribute value.
 *
 ...
 *
 */
export function findEl<T>(fixture: ComponentFixture<T>, testId: string, throwError = true): DebugElement {
    return queryByCss<T>(fixture, testIdSelector(testId), throwError);
}

/**
 * Finds all elements with the given `test-id` attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by `test-id`
 */
...
/**
 * Gets the text content of an element with the given `test-id` attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by `test-id`
 */
...
/**
 * Sets the value of a form field with the given `test-id` attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by `test-id`
 * @param value Form field value
 ...
 * When finding other elements, use `findEl` / `findEls` and `test-id` attributes.
 *
