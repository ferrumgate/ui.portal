...
describe('ConfigIpIntelligenceListItemComponent', () => {
  let component: ConfigIpIntelligenceListItemComponent;
  let fixture: ComponentFixture<ConfigIpIntelligenceListItemComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ConfigIpIntelligenceListItemComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ConfigIpIntelligenceListItemComponent);
